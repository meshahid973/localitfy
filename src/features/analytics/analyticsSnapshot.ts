...
export function makeLocaltifyAnalyticsSnapshotFallback(input: LocaltifyAnalyticsSnapshotInput): LocaltifyAnalyticsSnapshot {
  return computeLocaltifyAnalyticsSnapshot(input);
}

export function createLocaltifyLibraryWorker() {
  try {
